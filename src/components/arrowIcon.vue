<template>
  <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 595.513 595.513"
    xml:space="preserve">
    <g>
      <g>
        <path
          d="M592.403,232.481c-2.068-2.075-4.712-3.097-7.925-3.097H154.389v-52.968c0-4.59-2.185-7.932-6.548-9.988
